<section class="flex-1 overflow-y-auto flex flex-col  dark:bg-[#1e2020]">
    <div class="dark:bg-[#27282b] h-[31.5px] p-1 flex items-center justify-between">
        <div class="flex items-center space-x-5 ">
            ...
            <x-hugeicons-clock-02 class="w-4 h-4 dark:hover:text-gray-400 cursor-pointer dark:text-gray-300"
                                  stroke-width="2"/>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                 stroke="currentColor"
            ...
            <div class="flex px-4 py-1.5 space-x-2 items-center rounded dark:bg-[#27282b] bg-[#f8f8f8]">
                ...
                <div class="relative">
                    <button @click="open = !open"
                            type="button"
                            class="flex items-center space-x-2 inline-block border bg-[#0078c5] border-[#0078c5] hover:bg-[#0068ac] text-white dark:border-[#4a92fe] dark:bg-[#4a92fe] dark:hover:bg-[#5080d3] dark:text-white text-[12px] px-3 py-1 rounded transition duration-300 mr-2">
                    ...
                    <div x-show="open" @click.outside="open = false"
                        ...
                        <div    class="inline-block border bg-[#0078c5] border-[#0078c5] hover:bg-[#0068ac] text-white dark:border-[#4a92fe] dark:bg-[#4a92fe] dark:hover:bg-[#5080d3] dark:text-white text-[12px] px-3 py-1 rounded transition duration-300 mr-2">
                            Add to notebooks
                        </div>
